...
${OBJECTDIR}/CompareLabelFunctor.o: CompareLabelFunctor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CompareLabelFunctor.o CompareLabelFunctor.cpp

${OBJECTDIR}/CompareDegreeFunctor.o: CompareDegreeFunctor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CompareDegreeFunctor.o CompareDegreeFunctor.cpp
